...
- **Calendar follow-ups (TBD):**
  ...
  - **"+N more" popover UX.** P2. Status: **Settled for now (2026-06-21), revisit later.** Current fix: `moreLinkClick="day"` navigates to Day view instead of showing a popover (because the popover clips against the split-pane overflow). Works but the navigate-away feels wrong. A body-portaled custom popover would be better — revisit when doing the full calendar polish pass.
